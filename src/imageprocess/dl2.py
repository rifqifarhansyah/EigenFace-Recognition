...
# img=Image.open("D://ITB 21//KULYAHHH//SEMESTER 3//AlGeo//TUBES 2 ALGEO//Algeo02-21099//test//Coba_coba//Data_Set//pins_Alvaro Morte//Alvaro Morte41_248.jpg")
# numpydata=np.asarray(img) 
# print(numpydata.shape)
# imgres=adjustOneImage(numpydata)
# print(imgres.shape)
InputFolderWithCrop("test/Coba_coba/vieri","test/Coba_coba/resvieri")
# croppicture("D:/ITB 21/KULYAHHH/SEMESTER 3/AlGeo/TUBES 2 ALGEO/Algeo02-21099/test/Coba_coba/vieri/20221119_010933.jpg","D:/ITB 21/KULYAHHH/SEMESTER 3/AlGeo/TUBES 2 ALGEO/Algeo02-21099/test/Coba_coba/vieri/20221119_010933.jpg")
# img2=cv2.imread("test//Coba_coba/Data_Set/pins_Alex Lawther/Alex Lawther5_120.jpg")
# print(img2.shape)
# print(img2.shape)
# img3=adjustOneImage(img2)
# img2=adjustOneImage("D:/ITB 21/KULYAHHH/SEMESTER 3/AlGeo/TUBES 2 ALGEO/Algeo02-21099/test/Input/612.png")
# cv2.imshow("ass",img2)
...
# print(arr)
# # image=cv2.imread("D:/Kuliah/Semester 3/IF2123 Aljabar Linier dan Geometri/Algeo02-21099/test/Data_Set/pins_Anne Hathaway/Anne Hathaway82_482.jpg")
# cnt=1
# for i in arr :
